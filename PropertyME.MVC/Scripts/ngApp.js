...
angular.module('prop365App.services', [])
    .factory('propertyFactory', function ($resource) {
        return $resource('http://localhost:62640/Property365Service/Property/')
    });

angular.module('prop365App.controllers', []).controller('propertyController', function ($scope, propertyFactory) {
    $scope.props = propertyFactory.query();
});
...
angular.module('prop365App.controllers', []).controller('userController', function ($scope, userFactory) {
    ...
    $scope.updateUser = function () {
        ...
        if (image) {
            ...
            $scope.user.Picture.ImageName = 'test';
            //$scope.user.Picture.ImageData = JSON.stringify(image);
        }
    ...
    imageInput.fileinput({
        //uploadUrl: 'http://localhost:62640/Property365Service/AddPicture/',
